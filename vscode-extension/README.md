...
Official syntax highlighting, snippets, and language support for the **Flint** programming language (v1.7.2). 
...
* **Pipeline & Safety Support:** Deep integration for Flint's signature data-flow operator (`~>`) and the new v1.7.2 safety primitives (`expect`, `fallback`).
...
1. Download the latest `flint-lang-1.7.2.vsix` from the [Releases page](https://github.com/lucaas-d3v/flint/releases).
