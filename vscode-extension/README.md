...
Official syntax highlighting, snippets, and language support for the **Flint** programming language (v1.14.0-dev).
...
1. Download the latest `flint-lang-1.14.0-dev.vsix` from the [Releases page](https://github.com/lucaas-d3v/flint/releases).
2. Run:
   ```bash
   code --install-extension flint-lang-1.14.0-dev.vsix
   ```
